...
export default function DualityHero() {
  ...
  return (
    <section className="relative w-full min-h-screen h-[120vh] md:h-screen overflow-hidden">
      {/* Split panels */}
      <div className="flex h-full">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col justify-between h-full p-8 md:p-16 pt-64 md:pt-72 pb-20 md:pb-24">
            <div>
              <motion.p
        ...
        >
          ...
          <div className="relative z-10 flex flex-col justify-between items-end h-full p-8 md:p-16 pt-64 md:pt-72 pb-20 md:pb-24 text-right">
            <div>
              <motion.p
                className="font-serif text-2xl font-semibold italic tracking-[0.35em] uppercase text-white/70 mb-4"
