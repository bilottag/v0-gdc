  ...
  return (
    <section id="portfolio" className="relative py-12 md:py-16 bg-section-neutral">
      ...
      <div className="px-6 md:px-[4vw] mb-16">
        ...
        >
          <p
            className="font-sans text-[20px] font-semibold transition-[font-size] duration-200 has-[a:hover]:text-[22px]"
        ...
        <div className="flex gap-6 pl-6 md:pl-[4vw] pr-6 md:pr-[8vw] pb-8" style={{ width: 'max-content' }}>
          ...
          >
            ...
            <div className="mt-4">
              ...
              <p className="font-sans text-sm text-muted-foreground mt-1">A sleek hybrid office setup shares the room with a cozy sectional to unwind on after a hard day of work.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-4">
              ...
              <p className="font-sans text-sm text-muted-foreground mt-1">Deep navy walls and crisp white wainscotting wrap this charming nursery in warmth and calm.</p>
            </div>
          </motion.div>
